...
exports.default = {
    create: function () {
        var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
            var body, material, existLugar, matActual2, _matActual, lug;
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 8:
                            matActual2 = _context.sent;
                            return _context.abrupt('return', res.status(200).json({ ok: true, matActual2: matActual2 }));
                        ...
                        case 15:
                            _matActual = _context.sent;
                            _context.next = 18;
                            return _lugar2.default.findByIdAndUpdate({ _id: body.lugar }, { $push: { 'materiales': _matActual._id } }, { new: true });

                        case 18:
                            lug = _context.sent;
                            return _context.abrupt('return', res.status(200).json({ ok: true, matActual2: _matActual }));
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            return _context2.abrupt('return', res.status(200).json({ ok: true, mensaje: 'Bienvenido' }));
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 5;
                            return _material2.default.find().populate('lugar', 'nombre').populate('usuario', 'nombre apellido');

                        case 5:
                            materiales = _context3.sent;
                            return _context3.abrupt('return', res.status(200).json({ ok: true, materiales: materiales }));
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 7:
                            return _context4.abrupt('return', res.status(200).json({ ok: true, material: material }));
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 4:
                            ...
                            return _context5.abrupt('return', res.status(404).json({ ok: false, mensaje: 'No se encontro el material' }));
                        ...
                        case 27:
                            return _context5.abrupt('return', res.status(200).json({ ok: true, mensaje: 'Material eliminado correctamente', materialD: materialD }));

                        case 30:
                            _context5.prev = 30;
                            _context5.t0 = _context5['catch'](0);
                            return _context5.abrupt('return', res.status(500).json({ ok: false, error: _context5.t0 }));
    ...
    update: function () {
        var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(req, res) {
            var id, body, mater, user, des, existLugar, mafind, matActual2, _nuevoOrigen, _matActual3, viejoOrigen, matActual1, nuevoOrigen, _matActual2, lugarExiste;
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 16:
                            matActual2 = _context6.sent;
                            return _context6.abrupt('return', res.status(200).json({ ok: true, matActual2: matActual2 }));
                        ...
                        case 27:
                            _matActual3 = _context6.sent;
                            return _context6.abrupt('return', res.status(200).json({ ok: true, matActual2: _matActual3 }));
                        ...
                        case 31:
                            viejoOrigen = _context6.sent;
                            _context6.next = 34;
                            return _material2.default.findByIdAndUpdate(id, { $set: { 'asignado': false, 'desvincular': false }, $unset: { 'lugar': mater.lugar } }, { new: true });

                        case 34:
                            matActual1 = _context6.sent;
                            _context6.next = 37;
                            return _lugar2.default.findByIdAndUpdate({ _id: mater.lugar }, { $push: { 'materiales': mafind._id } }, { new: true });

                        case 37:
                            nuevoOrigen = _context6.sent;
                        ...
                        case 42:
                            _matActual2 = _context6.sent;
                            _context6.next = 45;
                            return _lugar2.default.findById({ _id: mater.lugar });

                        case 45:
                            lugarExiste = _context6.sent;
                            return _context6.abrupt('return', res.status(200).json({ ok: true, matActual2: _matActual2 }));
                        ...
                        case 49:
                            ...
                            return _context6.abrupt('return', res.status(500).json({ ok: false, error: { message: 'Error al actualizar el material' }, algo: _context6.t0 }));
